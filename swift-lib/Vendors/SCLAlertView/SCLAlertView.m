...
#pragma clang diagnostic pop
    ...
    if(!_rootViewController && _usingNewWindow)
    {
...
{
    [self showTitle:nil image:nil color:nil title:title subTitle:subTitle duration:kDefaultAnimationDuration completeText:nil style:Notice];
}
